# getCursorPos was added to the standard libaray here: https://github.com/nim-lang/Nim/pull/22749
# this file exist because I want to use it without waiting for it to show up in a released version of nim
